...
func (cli *Client) doHandshake(fs *socket.FrameSocket, ephemeralKP keys.KeyPair, queues handlerQueues) (chan *waBinary.Node, error) {
	...
	ns, err := nh.Finish(fs, cli.makeFrameHandlerForQueues(queues), cli.onDisconnect)
	if err != nil {
